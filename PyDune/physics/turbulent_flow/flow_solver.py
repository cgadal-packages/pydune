r"""
In this module, the function :func:`solve_turbulent_flow <PyDune.turbulent_flow.solve_turbulent_flow>`
...
def solve_turbulent_flow(model, parameters, Kappa=0.4, max_z=None,
    ...
    **kwargs :
    ...
    solution: func, list of func
        ...
        :func:`ODE_solution <scipy.integrate.OdeSolution>`. See corresponding
